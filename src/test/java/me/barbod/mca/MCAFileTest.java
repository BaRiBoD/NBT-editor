...
public class MCAFileTest extends MCATestCase {
    ...
    public void testChangeLastUpdate() {
        ...
        assertEquals(to.getChunk(0).getLastMCAUpdate(), to.getChunk(512).getLastMCAUpdate());
        assertEquals(to.getChunk(0).getLastMCAUpdate(), to.getChunk(1023).getLastMCAUpdate());
    }
    ...
    public void testGetters() {
        ...
        assertEquals(JListTag.createUnchecked(null), f.getChunk(0).getEntities());
    ...
    private Chunk createChunkWithPos() {
        JCompoundTag data = new JCompoundTag();
        JCompoundTag level = new JCompoundTag();
    ...
    public void testSetBlockDataAt() {
        ...
        JListTag<JCompoundTag> s = f.getChunk(1, 0).updateHandle(65, 64).getCompoundTag("Level").getListTag("Sections").asCompoundTagList();
        ...
        JListTag<JCompoundTag> ss = f.getChunk(66, 64).updateHandle(66, 64).getCompoundTag("Level").getListTag("Sections").asCompoundTagList();
        ...
        JListTag<JCompoundTag> sss = f.getChunk(31, 31).updateHandle(65, 65).getCompoundTag("Level").getListTag("Sections").asCompoundTagList();
