...
public final class NBTUtil {
    ...
    public static void write(JTag<?> tag, File file, boolean compressed) throws IOException {
        write(new NamedTag(null, tag), file, compressed);
    }

    public static void write(JTag<?> tag, String file, boolean compressed) throws IOException {
        write(new NamedTag(null, tag), new File(file), compressed);
    }

    public static void write(JTag<?> tag, File file) throws IOException {
        write(new NamedTag(null, tag), file, true);
    }

    public static void write(JTag<?> tag, String file) throws IOException {
    ...
    public static void writeLE(JTag<?> tag, File file, boolean compressed) throws IOException {
        writeLE(new NamedTag(null, tag), file, compressed);
    }

    public static void writeLE(JTag<?> tag, String file, boolean compressed) throws IOException {
        writeLE(new NamedTag(null, tag), new File(file), compressed);
    }

    public static void writeLE(JTag<?> tag, File file) throws IOException {
        writeLE(new NamedTag(null, tag), file, true);
    }

    public static void writeLE(JTag<?> tag, String file) throws IOException {
